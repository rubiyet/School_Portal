        ...
        <table width="100%" id="navbartable">
            <tr>
                <td width="23%" valign="top">
                    <a href="courses_&_results.php"><button id=button4>&nbsp;<i class="fa fa-book fa-lg"></i>&nbsp;&nbsp;Course & Results</button></a>
                    <!-- <div id="fulldropbox">
                        <button class="dropdownjs" id="button"><i class="fa fa-book fa-lg"></i>&nbsp;&nbsp;Course & Results<i class="fa fa-caret-down fa-lg icon"></i></button>
                    ...
                    <div id="fulldropbox">
                        ...
                        <a href="18-37646-1_password_change.php"><button id=button4>&nbsp;<i class="fa fa-key fa-lg"></i>&nbsp;&nbsp;Password Change</button></a>
                </td>
            </tr>
        </table>
