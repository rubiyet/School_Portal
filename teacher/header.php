<?php
    ...
    include '../controller/php_controller/teacher_controller.php';

    $teacher = teacherpersonalinfo($_COOKIE["__RequestVerificationToken"]);
                    ...
                    <table width="100%" id="headertable">
                        <tr>
                            ...
                            <td align="right" width="50%">
                                <span id="admindashboard"><b>Teacher Dashboard</b></span><br><form action="" method="POST"><span id="welcome">Welcome </span><a href="personal_info.php" id="personalinfo"><?php if(!empty($_SESSION["teachername"])){echo $_SESSION["teachername"];} ?></a>
                            </td>
                            <td id="">        
