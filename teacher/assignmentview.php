<?php
    ...
    $allassignmentview = allassignmentview();
                                    ...
                                    <tr>
                                        <td valign="top">
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    <td>
                                                        <table width='100%' style='border-collapse: collapse;border-bottom:1px solid gray'>
                                                            <tr>
                                                                <td width="33%"><b>STUDENT ID</b></td>
                                                                <td width="33%"><b>ASSIGNMENT</b></td>
                                                                <td width="33%"><b>SUBMIT TIME</b></td>
                                                                <td></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <?php
                                                    for($n = 2; $n < count($allassignmentview);$n++){
                                                        echo "<tr>";
                                                        echo "<td>";
                                                        echo "<table width='100%' style='border-collapse: collapse;border-bottom:1px solid gray'>";
                                                        echo "<tr>";
                                                        echo "<td></td>";
                                                        echo "<td width='33%'><b><a id='notefilename' download='".$allassignmentview[$n]."' href='assignmentview/".$forcourseandresultslist1."/".$allassignmentview[$n]."'>".$allassignmentview[$n]."</a></b></td>";
                                                        echo "<td width='33%'>".date("m-d-Y H:i:sa", filemtime('assignmentview/'.$forcourseandresultslist1.'/'.$allassignmentview[$n]))."</td>";
                                                        echo "</tr>";
                                                        echo "</table>";
                                                        echo "</td>";
                                                        echo "</tr>";
