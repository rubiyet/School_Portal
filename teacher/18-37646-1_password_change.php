                                        ...
                                        <td valign="top">
                                            <table id="">
                                                <form action = "" method = "POST">
                                                    <tr>
                                                        <td>Old Password</td>
                                                        <td>: <input type="password" name="oldpassword" value="<?php echo $old_password; ?>" placeholder="Old Password"> </td>
                                                        <td><span> <?php echo $err_old_password;?> </span></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="2" align="center"><input type="submit" name="teacherpasswordchange" value="Change"></td>
                                                    </tr>
				                                </form>
                                            </table>
                                        </td>
