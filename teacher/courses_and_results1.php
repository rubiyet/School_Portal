<?php
    ...
    $classschedule = teacherclassschedule1($__RequestVerificationToken);
                                            ...
                                            <table align="" id="frameitem" width="100%">
                                                <tr>
                                                    ...
                                                    <td width="100%" align="center">
                                                        <form method="POST">
                                                        Semester:
                                                        <select id="semester" name="semester"><option disabled selected>Semester</option><?php foreach($sy as $n){if($n == $forcourseandresultslist3) echo "<option selected>$n</option>"; else echo "<option>$n</option>";}?></select>
