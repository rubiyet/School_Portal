                                    ...
                                    <tr>
                                        <td valign="top">
                                            <table align="" id="frameitem" width="100%">
                                                ...
                                                <tr>
                                                    <?php
                                                        echo "<td width='100%'align='center' style='padding:3px;'><a href='studentsinfo.php?cs_id=".$classschedule1["cs_id"]."&semester=".$classschedule1["semester"]."'><button id='button30'>Students Info</button></a>&nbsp;&nbsp;<a href='result.php?cs_id=".$classschedule1["cs_id"]."&semester=".$classschedule1["semester"]."'><button id='button30'>Result</button></a>&nbsp;&nbsp;<a href='note.php?cs_id=".$classschedule1["cs_id"]."&semester=".$classschedule1["semester"]."'><button id='button30'>Upload Note</button></a></td>";
                                                    ?>    
                                                </tr>
                                                <tr>
                                                    <?php
                                                        echo "<td width='100%'align='center' style='padding:3px;'><a href='notice.php?cs_id=".$classschedule1["cs_id"]."&semester=".$classschedule1["semester"]."'><button id='button30'>Notice</button></a>&nbsp;&nbsp;<a href='assignment.php?cs_id=".$classschedule1["cs_id"]."&semester=".$classschedule1["semester"]."'><button id='button30'>Assignment</button></a>&nbsp;&nbsp;<a href='generate_report.php?cs_id=".$classschedule1["cs_id"]."&semester=".$classschedule1["semester"]."'><button id='button30'>Generate Report</button></a></td>";
                                                    ?>    
                                                </tr>
                                            </table>
                                        </td>
