...
var dropdowncontainer6 = document.getElementById("dropdowncontainer6");
...
for(i = 0; i < dropdown.length; i++) {
  dropdown[i].addEventListener("click", function() {
    ...
    if(dropdownContent.style.display === "block") {
      ...
      dropdowncontainer6.style.display = "none";
    }
  });
}
...
var dropdown6 = document.getElementsByClassName("dropdownjs6");

for (i = 0; i < dropdown6.length; i++) {
