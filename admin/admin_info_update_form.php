<?php
    ...
    getadminupdate($adminidforupdate);
                            ...
                            <td width="77%" valign="top">
                                <table id="frame">
                                    ...
                                    <tr>
                                        <td valign="top">
                                            <table id="frameitem">
                                                <form action = "" onsubmit="return adminupdatevalidatebyjs()" method = "POST" enctype="multipart/form-data" autocomplete="off">
                                                    <tr>
                                                        <td></td>
                                                        <td width="20%"><input type="hidden" name="image1" value="<?php if(!empty($image)){echo $image;}?>"></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" width="40%" id="subtitle">Admin ID<span id="star">* </span>: </td>
                                                        <td width="20%"><input id="adminid" type="text" name="adminid" placeholder="**-1***" value="<?php echo $adminid;?>"></td>
                                                        <td width="30%" align="left"><span id="error_adminid"><?php echo $error_adminid?></span></td>
                                                        <td width="12%" rowspan="5" width="" id="imagebox">
                                                            <img src="<?php if(!empty($image)){ echo "image/admin/".$image;} else{ echo "";}?>?>" id="image1">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" id="subtitle">Name<span id="star">* </span>: </td>
                                                        <td><input id ="name" type="text" name="name" value="<?php if(!empty($name)){echo $name;}?>"></td>
                                                        <td><span id="error_name"><?php echo $error_name?></span></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" id="subtitle">Salary<span id="star">* </span>: </td>
                                                        <td><input id="salary" type="text" name="salary" value="<?php if(!empty($salary)){echo $salary;}?>"></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2"><span id="error_email"><?php echo $error_email?></span></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2"><span id="error_fathername"><?php echo $error_fathername?></span></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" id="subtitle">
                                                        ...
                                                        <td colspan="2"><span id="error_mothername"><?php echo $error_mothername?></span></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right" id="subtitle">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input id="sameaspresentaddress" type="checkbox" name="sameaspresentaddress" <?php if($presentaddress != ""){if($presentaddress == $parmanentaddress) echo "checked";}?>> <span id="sameaspresentaddress">Same as present address</span> <br>
                                                    ...
                                                    <tr>
                                                        <td></td>
                                                        <td id="buttonbox">
                                                            <input type="submit" name="adminupdate" value="Update" id="button10">&emsp;<input type="submit" name="backforupdate" value="Back" id="button10">
                                                        </td>
                                                    </tr>
                                                </form>
                                            </table>
