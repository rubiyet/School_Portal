                    ...
                    <table width="100%" height="830" valign="top" >
                        <tr>
                            ...
                            <td width="77%" valign="top">
                                <table id="frame">
                                    <tr>
                                        <td colspan="3" id="title" valign="center">OPEN COURSE UPDATE</td>
                                    </tr>
                                    <tr>
                                        <td valign="top">
                                            <table id="frameitem">
                                                <form action = "" method = "POST">
                                                    <tr>
                                                        ...
                                                        <td width="" id="enterbutton15"><input type="submit" name="enterforcourseopenupdate" value="Enter" id="button10"></td>
