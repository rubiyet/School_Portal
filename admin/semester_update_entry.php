                                        ...
                                        <table id="frameitem">
                                                <form action="" method="POST">
                                                    <tr>
                                                        ...
                                                        <td width="34%"><span id="error_semester_year"><?php echo $error_semester_year;?></span></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">
                                                            Semester: 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td id="buttonbox" valign="middle">
                                                            <table width="80%">
                                                                <tr>
                                                                    <td><input type="Submit" name="enterforsemesterupdate" value="Update" id="button10"></td></form>
