                                            ...
                                            <table width="100%">
                                                ...
                                                <?php
                                                    for($n = 2; $n < count($allnote);$n++){
                                                        ...
                                                        echo "<tr>";
                                                        echo "<td width='50%'><b><a id='notefilename' download='".$allnote[$n]."' href='..teacher/note/".$forcourseandresultslist1."/".$allnote[$n]."'>".$allnote[$n]."</a></b></td>";
                                                        echo "<td width='50%'>".date("m-d-Y H:i:sa", filemtime('../teacher/note/'.$forcourseandresultslist1.'/'.$allnote[$n]))."</td><form method='POST'>";
                                                        echo "</tr>";
                                                        echo "</table>";
                                                        echo "</td>";
                                                        echo "</tr>";
