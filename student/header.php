<?php
    ...
    include '../controller/php_controller/student_controller.php';

    $student = studentpersonalinfo($_COOKIE["__RequestVerificationToken"]);
                    ...
                    <table width="100%" id="headertable">
                        <tr>
                            ...
                            <td align="right" width="50%">
                                <span id="admindashboard"><b>Student Dashboard</b></span><br><form action="" method="POST"><span id="welcome">Welcome </span><a href="personal_info.php" id="personalinfo"><?php if(!empty($_SESSION["studentname"])){echo $_SESSION["studentname"];} ?></a>
                            </td>
                            <td id="">        
