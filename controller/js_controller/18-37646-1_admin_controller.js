...
function teacherupdatevalidatebyjs(){
	refresh3();
	if(get("teacherid").value==""){
		error=true;
		get("error_teacherid").innerHTML="*Teacher id required";
    ...
    if(get("gender").value == ""){
        error = true;
        get("error_gender").innerHTML = "*Birth Day, Month & Year Required";
    }
    if(get("input_date_of_birth").value == ""){
        error = true;
        get("error_input_date_of_birth").innerHTML = "*Birth Day, Month & Year Required";
    }
    if(get("nationality").value == ""){
   ...
   if(get("father_name").value == ""){
	...
	if(get("join_date").value == ""){
		error = true;
		get("error_join_date").innerHTML = "*Must be need Mother Name";
	}
    if(get("left_date").value == ""){
		error = true;
		get("error_left_date").innerHTML = "*Must be need Mother Name";
	}
    if(get("qualifications").value == ""){
		error = true;
		get("error_qualifications").innerHTML = "*Must be need Mother Name";
	}
	if(get("present_address").value == ""){
        error = true;
        get("error_present_address").innerHTML = "*Must be need Present Address";
